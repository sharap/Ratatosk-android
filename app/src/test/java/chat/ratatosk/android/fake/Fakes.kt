...
open class FakeClient : RatatoskClientInterface {
    ...
    override fun `admitToChannel`(`chatId`: kotlin.ByteArray, `peerIk`: kotlin.ByteArray): Unit = notCalled("admitToChannel")
    ...
    override fun `channelAdmits`(`chatId`: kotlin.ByteArray): List<FfiChannelAdmit> = notCalled("channelAdmits")
    override fun `channelGrants`(`chatId`: kotlin.ByteArray): List<FfiChannelGrant> = notCalled("channelGrants")
    override fun `channelLink`(`chatId`: kotlin.ByteArray): kotlin.String = notCalled("channelLink")
    override fun `channelRequests`(`chatId`: kotlin.ByteArray): List<FfiChannelRequest> = notCalled("channelRequests")
    override fun `channelSeeds`(`chatId`: kotlin.ByteArray): List<FfiChannelSeed> = notCalled("channelSeeds")
    override fun `chatIdFor`(`peerIk`: kotlin.ByteArray): kotlin.ByteArray = notCalled("chatIdFor")
    override fun `chatNotify`(`chatId`: kotlin.ByteArray): FfiNotify = notCalled("chatNotify")
    ...
    override fun `givingLimits`(): FfiGivingLimits = notCalled("givingLimits")
    ...
    override fun `rotateChannelKey`(`chatId`: kotlin.ByteArray): Unit = notCalled("rotateChannelKey")
    override fun `search`(`chatId`: kotlin.ByteArray?, `query`: kotlin.String, `limit`: kotlin.UInt): List<FfiMessage> = notCalled("search")
    override fun `seeding`(`chatId`: kotlin.ByteArray): kotlin.Boolean = notCalled("seeding")
    override fun `seedingMode`(`chatId`: kotlin.ByteArray): FfiSeeding = notCalled("seedingMode")
    ...
    override fun `setChannelPow`(`chatId`: kotlin.ByteArray, `bits`: kotlin.UInt): Unit = notCalled("setChannelPow")
    override fun `setChannelRight`(`chatId`: kotlin.ByteArray, `who`: kotlin.ByteArray, `rights`: FfiChannelRights, `untilMs`: kotlin.ULong): Unit = notCalled("setChannelRight")
    override fun `setChatNotify`(`chatId`: kotlin.ByteArray, `silent`: kotlin.Boolean, `untilMs`: kotlin.ULong): Unit = notCalled("setChatNotify")
    override fun `setForeground`(`front`: kotlin.Boolean): Unit = notCalled("setForeground")
    override fun `setGivingLimits`(`limits`: FfiGivingLimits): Unit = notCalled("setGivingLimits")
    ...
    override fun `unsubscribeFromChannel`(`chatId`: kotlin.ByteArray): Unit = notCalled("unsubscribeFromChannel")
